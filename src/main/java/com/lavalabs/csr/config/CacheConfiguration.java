package com.lavalabs.csr.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.lavalabs.csr.domain.User.class.getName(), jcacheConfiguration);
            ...
            cm.createCache(com.lavalabs.csr.domain.PackageOrder.class.getName(), jcacheConfiguration);
            cm.createCache(com.lavalabs.csr.domain.MerchantPackagePhoto.class.getName(), jcacheConfiguration);
